...
For complete details on org-roam-ui's architecture, see [[file:org-roam-ui-research.md][org-roam-ui research]].

* Executive Summary

Recommended approach: *Dual-component architecture with real-time synchronization*

- **Emacs Backend**: Elisp package that queries org-edna data and serves it via WebSocket/HTTP
...
│  │  • Parse org-edna dependencies                     │     │
│  │  • Extract task metadata                           │     │
│  │  • HTTP Server :36901                              │     │
│  │  • WebSocket Server :36903                         │     │
│  │  • Track org-agenda file changes                   │     │
│  └────────────────────────────────────────────────────┘     │
│                          ↕                                   │
│                    WebSocket + HTTP                          │
└──────────────────────────────────────────────────────────────┘
...
- *org-edna-graph*: Parse org files directly (slower, but more flexible)
- *Impact*: More caching needed, incremental parsing
...
** Graph Size
- *org-roam-ui*: Can be thousands of nodes
- *org-edna-graph*: Typically <100 tasks per project
- *Impact*: Performance less critical, but still important

* Implementation Priorities

** Priority 1: Must Have (MVP)
1. Elisp backend that parses org-edna
